...
module.exports = ".app__wrapper {\n  padding: 0;\n  background-image: url('background.jpg');\n  background-size: cover;\n  min-height: 100vh;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var ng_animate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ng-animate */ "./node_modules/ng-animate/fesm5/ng-animate.js");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(planetsFacadeService, route) {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (params) {
            ...
            var page = _a.page, searchStr = _a.searchStr;
            return _this.planetsFacadeService.getPlanets(page, searchStr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {
                _this.loadingIndicator = true;
            }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) {
            _this._planets = data.planets;
            _this._pageCount = Array(data.pages).fill(0).map(function (num, iter) { return ({ num: (iter + 1) }); });
            _this._currentPage = data.currentPage;
            _this._planetsCount = data.count;
        })).subscribe();
    };
    Object.defineProperty(DashboardComponent.prototype, "planets", {
        get: function () {
    ...
    Object.defineProperty(DashboardComponent.prototype, "currentPage", {
        get: function () {
    ...
    Object.defineProperty(DashboardComponent.prototype, "planetsCount", {
        get: function () {
    ...
    DashboardComponent.prototype.clearSearchStr = function () {
...
var PlanetCardComponent = /** @class */ (function () {
    function PlanetCardComponent() {
        this.imgLink = '';
    }
    Object.defineProperty(PlanetCardComponent.prototype, "planet", {
    ...
    PlanetCardComponent.prototype.ngOnInit = function () {
    };
...
var PlanetDetailComponent = /** @class */ (function () {
    function PlanetDetailComponent(route, planetFacadeService) {
        this.route = route;
        this.planetFacadeService = planetFacadeService;
    }
    PlanetDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.planet = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (params) { return _this.planetFacadeService.getPlanetDetail(+params.get('id')); }));
    };
    PlanetDetailComponent.ctorParameters = function () { return [
...
var PlanetsFacadeService = /** @class */ (function () {
    function PlanetsFacadeService(planetsService) {
        this.planetsService = planetsService;
    }
    PlanetsFacadeService.prototype.getPlanets = function (page, searcStr) {
        if (page === void 0) { page = 1; }
        if (searcStr === void 0) { searcStr = ''; }
        return this.planetsService.getMainObject(page, searcStr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (planets) {
            var pages = Math.ceil(planets.count / 10);
    ...
    PlanetsFacadeService.prototype.getPlanetDetail = function (id) {
        return this.planetsService.getDetail(id);
    };
    PlanetsFacadeService.ctorParameters = function () { return [
...
var PlanetsService = /** @class */ (function () {
    ...
    PlanetsService.prototype.getMainObject = function (page, searchStr) {
        return this.http.get("https://swapi.co/api/planets/?search=" + searchStr + "&page=" + page);
    };
    PlanetsService.prototype.getDetail = function (id) {
        return this.http.get("https://swapi.co/api/planets/" + id);
    };
    PlanetsService.ctorParameters = function () { return [
