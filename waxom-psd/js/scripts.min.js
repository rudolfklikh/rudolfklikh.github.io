...
function countNumbers(){var e=$(".counters").offset().top+$(".counters").outerHeight(),t=!0;$(window).scroll(function(){$(window).scrollTop()+950>e&&1==t&&($(".counter-item__number").each(function(){$(this).prop("Counter",0).animate({Counter:$(this).text()},{duration:5e3,easing:"swing",step:function(e){$(this).text(Math.ceil(e))}})}),t=!1)})}function clickMenu(){$(".main-header__navigation li").on("click",'a[href^="#"]',function(e){e.preventDefault();var t=this.hash;$target=$(t),$("html, body").stop().animate({scrollTop:$target.offset().top},1e3,"swing",function(){window.location.hash=t})})}function showTopButton(){var e=$(".header-section").offset().top+$(".header-section").outerHeight();$(window).scroll(function(){$(window).scrollTop()>e/1.5?$(".button-top__wrapper").fadeIn():$(".button-top__wrapper").fadeOut()})}function scrollToTop(){$(".button-top").click(function(){$("body,html").animate({scrollTop:0},800)})}function loader(){$("body").addClass("loaded")}function mixerCheck(){mixitup(".mix-container").configure({animation:{effects:"fadeIn",duration:500}})}function enableSliders(){$(".slider").slick({dots:!0}),$(".post-slider").slick({slidesToShow:3,slidesToScroll:1,arrows:!0,cssEase:"linear"})}function checkVideoStatus(){var e=document.getElementById("play-pause"),t=document.getElementsByClassName("play-widok"),o=document.getElementById("main-video"),n=document.getElementById("video-section"),i=document.getElementsByClassName("video-text");document.getElementById("full-screen");e.addEventListener("click",function(){1==o.paused?(o.play(),jQuery(t).addClass("paused")):(o.pause(),jQuery(t).removeClass("paused"))}),n.addEventListener("mouseleave",function(){jQuery(i).css("opacity","0")}),n.addEventListener("mouseover",function(){jQuery(i).css("opacity","1")})}function checkLink(){$(".projects-navigation ul").on("click","li",function(){$(".active").removeClass("active"),$(this).addClass("active")})}$(document).ready(function(){loader(),showTopButton(),scrollToTop(),enableSliders(),checkVideoStatus(),mixerCheck(),checkLink(),countNumbers()});